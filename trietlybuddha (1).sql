...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 03, 2021 lúc 07:28 AM
...
(20, 'Tiên tri zũ trụ Trần Dần 6', NULL, 1, '<p>TD</p><figure class=\"image image-style-align-left\"><img src=\"/kesachphatgiao/public/images/introduce/files/mqdefault.jpg\"><figcaption>TD 6</figcaption></figure>', '2021-02-26 06:12:13', 22, '2021-02-26 13:12:13');
...
(6, 'dad953cf45e5332f60efb07e3ef0d9c0-1614319933.jpg', 1, 20);
...
--
ALTER TABLE `introduce`
  MODIFY `id` tinyint(4) NOT NULL AUTO_INCREMENT COMMENT 'id Phần giới thiệu', AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT cho bảng `introduce_images`
--
ALTER TABLE `introduce_images`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id Hình ảnh', AUTO_INCREMENT=7;
